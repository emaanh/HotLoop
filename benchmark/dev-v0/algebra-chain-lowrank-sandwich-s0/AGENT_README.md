# Task: Matmul chain (chain lowrank sandwich)
...
A product of four float32 matrices with shapes (8192, 64), (64, 8192), (8192, 64), (64, 16). Values are random and change with every call; shapes are fixed.
