# Task: Matmul chain (chain tall skinny)
...
A product of four float32 matrices with shapes (8192, 128), (128, 4096), (4096, 128), (128, 2048). Values are random and change with every call; shapes are fixed.
